...
1.	Identifikasi Aplikasi:
  Nama aplikasi, URL lengkap, dan anatomi URL (breakdown setiap komponen)
...
2.	Screenshot Network Tab: 
  Capture tampilan Network tab DevTools saat halaman utama dimuat
...
3.	5 HTTP Request: 
  Catat 5 request: method, status code, Content-Type, URL endpoint
  1)	Request 1
    a.	Method: GET
...
4.	Analisis Arsitektur: 
  Dugaan komponen fronted, backend, dan database yang digunakan sistem tersebut
...
5.	Diagram Arsitektur: 
  Gambarkan arsitektur sederhana sistem tersebut berdasarkan pengamatan saya
